...
.Ltext0:
	...
	.file 0 "/home/ubuntu/SoCLab/course-lab_6/lab-wlos_baseline/testbench/lab6_uart" "fir.c"
	.globl	taps
	.data
	.align	2
	.type	taps, @object
...
.L13:
	...
	add	a5,a4,a5
	lw	a3,0(a5)
	.loc 1 32 44 discriminator 3
	lw	a4,-20(s0)
	lw	a5,-24(s0)
	sub	a5,a4,a5
	.loc 1 32 42 discriminator 3
	lui	a4,%hi(inputsignal)
	addi	a4,a4,%lo(inputsignal)
	slli	a5,a5,2
	add	a5,a4,a5
	lw	a5,0(a5)
	.loc 1 32 30 discriminator 3
	mv	a1,a5
	mv	a0,a3
	call	__mulsi3
	mv	a5,a0
